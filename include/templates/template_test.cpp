...
struct Layers<CostFunction, Layer<Ins, Outs, Activations>...>
...
struct Linear {
  ...
  inline Eigen::Matrix<double, N, N> activation_der(
...
int main() {
  ...
  Layers<MeanSquareError, Layer<2, 2, Linear>, Layer<2, 2, Linear>> l;
